...
$dotenv = $dotenv = Dotenv\Dotenv::createImmutable(__DIR__, '.env');

function isPasswordCorrect() {
    $envPassword = getenv('pass'); // Fetch the password from the environment variable
    return isset($_POST['password']) && $_POST['password'] === $envPassword;
}
...
$webPath = getenv('path'); // Chemin web de votre choix
